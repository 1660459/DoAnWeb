...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 27, 2018 lúc 09:35 AM
...
CREATE TABLE `chitietdathang` (
  ...
  `DatHang_idDatHang` int(11) NOT NULL,
...
INSERT INTO `chitietdathang` (`id_don`, `so_luong`, `GIA`, `Thanhtien`, `DatHang_idDatHang`, `SanPham_id_sp`) VALUES
(1, 10, '150000000', '150000000', 1, 1),
(2, 3, '12500000', '37500000', 2, 2),
(3, 2, '5100000', '20400000', 3, 3),
(4, 1, '4923929', '4923929', 4, 4),
(5, 5, '7800000', '39000000', 5, 5),
(6, 1, '8990000', '8990000', 6, 6),
(7, 3, '5999000', '179007000', 7, 7),
(10, 1, '7999000', '7999000', 10, 10),
(11, 4, '4450000', '17800000', 17, 17);
...
CREATE TABLE `danhmuc` (
  ...
  `ten_danhmuc` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `danhmuc` (`idDanhMuc`, `ten_danhmuc`) VALUES
(1, 'Gucci'),
(2, 'Dior'),
(3, 'RayBen'),
(4, 'Prada'),
...
INSERT INTO `dathang` (`idDatHang`, `id_sanpham`, `ngay_tao`, `loai_giao`, `NguoiDung_idNguoiDung`) VALUES
(1, 0, '2018-12-12 11:06:12', 1, 1),
(2, 2, '2018-12-02 04:29:15', 1, 1),
(3, 3, '2018-12-09 16:23:18', 1, 1),
(4, 4, '2018-12-05 04:19:05', 1, 1),
(5, 5, '2018-12-03 04:34:08', 1, 2),
(6, 6, '2018-12-04 04:26:11', 1, 2),
(7, 7, '2018-12-05 12:18:49', 1, 2),
(8, 8, '2018-12-06 11:45:12', 1, 2),
(9, 9, '2018-12-08 08:32:44', 1, 3),
(10, 10, '2018-12-08 06:36:12', 1, 3),
(12, 11, '2018-12-01 09:35:11', 1, 3),
(13, 13, '2018-12-02 11:16:38', 1, 4),
(14, 14, '2018-12-08 10:18:40', 1, 4),
(15, 15, '2018-12-09 16:19:30', 1, 4),
(16, 16, '2018-12-05 21:35:10', 1, 5),
(17, 17, '2018-12-10 19:22:43', 1, 5),
(18, 18, '2018-12-05 15:19:30', 1, 5),
(19, 19, '2018-12-12 15:19:33', 1, 5),
(20, 1, '2018-12-11 21:23:26', 1, 5);
...
INSERT INTO `nguoidung` (`id`, `name`, `password`, `re_password`, `email`, `quyen`) VALUES
(1, 'nthin', '123', '123', 'thin@gmail.com', 0),
(2, 'phong', '123', '123', 'p@gmail.com', 0),
(3, 'maithi', '123', '123', 'nmthi@gmail.com', 0),
(4, 'thanhphu', '123', '123', 'ntphu@gmail.com', 0),
(5, 'bichphuong', '123456', '123456', 'bichphuong@gmail.com', 1),
(6, 'admin', 'admin', 'admin', 'admin@gmail.com', 0),
(7, 'a', 'a', 'a', 'bichphuong@gmail.com', 0),
(8, 'hello', 'hello', 'hello', 'hello@gmail.com', 0),
(10, 'BichPhuong123', '123', '123', 'bp@gmail.com', 1);
...
CREATE TABLE `nsx` (
  ...
  `ten_NSX` varchar(45) DEFAULT NULL,
  `noi_sx` varchar(45) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `nsx` (`idNSX`, `ten_NSX`, `noi_sx`) VALUES
(1, 'Công ty TNHH Patrick Eyewear', 'Italy'),
(2, 'LUXOTTICA-XX-ITALY', 'canada'),
(3, 'Coastal eyewear', 'Paris'),
(4, 'AKP Group', 'Italia'),
(5, 'Dolce & Gabbana', 'New York');
...
(25, 'P01', 'PRADA VPR16SF 1AB1O1', 'FRAME: Rectangle\r\nFACE MIRROR: Heart face\r\nSIZE: Standard\r\nGLASS FILM: Nylon plastic\r\nGROWTH: 54', 40, 'img/p1.jpg', '2018-11-14', 3222, 1, '5560000', 4, 4),
(26, 'P02', 'Prada  PR54TS-7OE6O2', '\r\nLens Color: Purple - Frame Color: Yellow - Frame Color: Yellow / Frames - Metal Material: Metal. Eyepieces: Silicon- Lens Material: Plastic- Lens Width: 55mm- Bridge Width: 18mm- Length: 135mm', 65, 'img/p2.jpg', '2018-11-20', 990, 1, '7565000', 4, 4),
(27, 'P03', 'PRADA – OPR64TS-7OEAD2', '\r\nAIR7 technology includes 7 superior features: high quality materials; lightweight; heat-resistant; good elastic; colorful; Environmental friendliness; not fade.', 32, 'img/p3.jpg', '2018-11-25', 800, 1, '8100000', 4, 4),
(28, 'P04', 'PRADA – OPR68TS-ZVN117', 'Material: Frame mainly from high acetate; Stainless Steel; pure titanium or titanium alloy;\r\nStylish young fashion', 60, 'img/p4.jpg', '2018-06-16', 7809, 1, '7860000', 4, 4),
(29, 'P05', 'PRADA SPR62U ROK 219', '\r\nMaterial: Frame mainly from high acetate; Stainless Steel; pure titanium or titanium alloy; .\r\nPolycarbonate resin meets international standards including 8 coatings\r\nAnti-UV (UV)\r\nElectro Magnetic Intereference (EMI)', 90, 'img/p5.jpg', '2018-11-14', 760, 1, '6630000', 4, 4),
(30, 'P06', 'PRADA VPR53I GAQ 101', '\r\nMaterial: Frame mainly from high acetate; Stainless Steel; pure titanium or titanium alloy; LIFE FORM 0', 60, 'img/p6.jpg', '2018-11-18', 900, 1, '4726000', 4, 4),
(31, 'P07', 'PRADA SPS50T 1BC 125', '\r\nMaterial: Frame mainly from high acetate; Stainless Steel; pure titanium or titanium alloy; .\r\nPolycarbonate resin meets international standards including 8 coatings\r\nAnti-UV (UV)\r\nElectro Magnetic Intereference (EMI)\r\nAnti-reflective (Hard Coating-HMC)', 90, 'img/p7.jpg', '2018-08-17', 7100, 1, '7000000', 4, 4),
(32, 'P08', 'PRADA SPS50S GAQ 5X1', 'Hard coating (HC)\r\nColoring (tinting and gradient)\r\nWaterproof (Hydrophobic)\r\nPhotochormic - corning (transition; sun sensor)\r\nOther plating (ex Polyvinyl Alcohol, polarized)', 70, 'img/p8.jpg', '2018-07-20', 1200, 1, '5950000', 4, 4),
(33, 'P09', 'PRADA PR19SSF-HAQ5P2', '100% UV protection\r\nPolazired No Yes\r\nDiameter of 19mm\r\nLong earrings: 140mm\r\nGlass Width According To Glass Size\r\nGlass height 40mm', 55, 'img/p9.jpg', '2018-10-22', 1020, 1, '7250000', 4, 4),
(34, 'P10', 'Prada SPS811B', '\r\nFeatures: Anti-corrosion metal alloy. Ultra-flexible frame.\r\n\r\nLens: Polycarbonate, high grade - UV high, with engraved Prada, polarized anti-glare', 90, 'img/p10.jpg', '2018-09-23', 1350, 1, '860000', 4, 4),
...
ALTER TABLE `chitietdathang`
  ...
  ADD KEY `fk_ChiTietDatHang_DatHang1` (`DatHang_idDatHang`),
  ADD KEY `fk_ChiTietDatHang_SanPham1` (`SanPham_id_sp`);
...
ALTER TABLE `dathang`
  ...
  ADD KEY `fk_DatHang_NguoiDung` (`NguoiDung_idNguoiDung`);
...
--
ALTER TABLE `dathang`
  MODIFY `idDatHang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `chitietdathang`
  ADD CONSTRAINT `fk_ChiTietDatHang_DatHang1` FOREIGN KEY (`DatHang_idDatHang`) REFERENCES `dathang` (`idDatHang`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_ChiTietDatHang_SanPham1` FOREIGN KEY (`SanPham_id_sp`) REFERENCES `sanpham` (`id_sp`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Các ràng buộc cho bảng `dathang`
--
ALTER TABLE `dathang`
  ADD CONSTRAINT `fk_DatHang_NguoiDung` FOREIGN KEY (`NguoiDung_idNguoiDung`) REFERENCES `nguoidung` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
